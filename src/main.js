...
q("#main-navigation").setAttribute(
  "aria-label",
  content.accessibilite.navigationPrincipale,
);
q("#social-navigation").setAttribute(
  "aria-label",
  content.accessibilite.reseauxSociaux,
);
...
q("#announcements").setAttribute(
  "aria-label",
  content.accessibilite.informationsClub,
);
q("#quick-links").setAttribute(
  "aria-label",
  content.accessibilite.accesRapides,
);
...
setLines("#brand-name", [
  content.identite.nomCourtLigne1,
  content.identite.nomCourtLigne2,
]);
...
setText(
  "#quick-schedule-description",
  content.accesRapides.horaires.description,
);
setText("#quick-registration-title", content.accesRapides.inscription.titre);
setText(
  "#quick-registration-description",
  content.accesRapides.inscription.description,
);
...
setText(
  ...
  content.sectionInscription.description + " ",
);
